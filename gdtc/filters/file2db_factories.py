...
def hdf2db(input_file_name, layer_num, coord_sys, table, host, port, user, password, db, reproject=False, srcSRS=None,
    ...
    f1 = gdtc.filters.file2file_factories.hdf2tif(layer_num, input_file_name, None, reproject, srcSRS, dstSRS, cell_res)
    f2 = gdtc.filters.file2file_factories.tif2sql(coord_sys, table, db)
